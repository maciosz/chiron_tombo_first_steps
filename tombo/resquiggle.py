...
def get_read_seq(
    ...
    # ~maciosz: it was try and except KeyError here
    # but get doesn't give you KeyError...
    # so I changed it to checking if read_id is None
    #try:
    ...
    if not read_id:
        ...
        read_id = "Read_" + unicode(read_data.attrs.get('read_number'))
        ##except KeyError:
...
def map_read(
    ...
    align_info = th.alignInfo(
        seq_data.id, #.decode(), ~commented out by maciosz
        bc_subgrp, num_start_clipped_bases,
